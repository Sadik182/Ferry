...
btn.onclick = function () {
  ...
  document.getElementById("tPname").innerHTML =
    document.getElementById("pName").value;
  document.getElementById("tPhone").innerHTML =
    document.getElementById("pPhone").value;
  document.getElementById("tSeat").innerHTML =
    document.getElementById("pSeatName").value;
  document.getElementById("tVname").innerHTML =
    document.getElementById("vName").value;
  document.getElementById("tVnumber").innerHTML =
  ...
  document.getElementById("sdDate").innerHTML =
    document.getElementById("date").value;
